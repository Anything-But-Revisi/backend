...
This specification defines the requirements for database health monitoring, including liveness checks, status reporting, and metrics collection for operational visibility.
